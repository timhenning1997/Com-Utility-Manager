...
class WindowTeleTableView(AbstractWindow):
    def __init__(self, hubWindow):
        ...
        self.list_IW_TE = [
            {"name": "TIW1", "UUID": "EcoFlex-TeleIW_PP0_0", "unit": "K"}, 
            {"name": "TIW2", "UUID": "EcoFlex-TeleIW_PP0_1", "unit": "K"}, 
            {"name": "TIW3", "UUID": "EcoFlex-TeleIW_PP0_2", "unit": "K"}] 
        
        self.list_IW_LTE = [
            {"name": "TLIW1", "UUID": "EcoFlex-TeleIW_PP1_0", "unit": "K"},
            {"name": "TLIW2", "UUID": "EcoFlex-TeleIW_PP0_3", "unit": "K"},
            {"name": "TLIW3", "UUID": "EcoFlex-TeleIW_PP1_1", "unit": "K"},
            {"name": "TLIW4", "UUID": "EcoFlex-TeleIW_PP1_2", "unit": "K"},
            {"name": "TLIW5", "UUID": "EcoFlex-TeleIW_PP0_4", "unit": "K"},
            {"name": "TLIW6", "UUID": "EcoFlex-TeleIW_PP1_3", "unit": "K"},
            {"name": "TLIW7", "UUID": "EcoFlex-TeleIW_PP1_4", "unit": "K"},
            {"name": "TLIW8", "UUID": "EcoFlex-TeleIW_PP0_5", "unit": "K"},
            {"name": "TLIW9", "UUID": "EcoFlex-TeleIW_PP1_5", "unit": "K"}]
