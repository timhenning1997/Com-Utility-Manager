...
class WindowTempCalFritoese(AbstractWindow):
    def __init__(self, hubWindow):
        ...
        cal = CalibratorFritteuse(self, "COM3")
        cal._maxBacklogSize = 4
        cal._isActiveCommunication = True
        cal.sendMessage("Message 1:")
        cal.sendMessage("Message 2:")
        cal.sendMessage("Message 3:")
        cal.sendMessage("Message 4:")
        cal.sendMessage("Message 5:")
        cal.sendMessage("Message 6:")

        print(cal._messageBacklog)
        print("________________")

        for message in cal._messageBacklog:
            print(message["message"], message["priority"])
